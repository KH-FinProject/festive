...
public class EmailConfig {
	 ...
	 * 2. Goole SMTP 서버로 전송 (Google 서버가 중간 배달자 역할)
	 * 3. Google SMTP 서버가 이메일주소에 맞는 “수신자”에게 이메일 서버(gmail 등)를 통해 발송
	 * 4. 최종 수신자 이메일을 받음
	 * 
	 * (참고) 기본 포트 25를 사용하지만, 보안 강화한 포트 587이나 465가 자주 사용됨
	 */
	
	// @Value : properties에 작성된 내용 중 key가 일치하는 key값을 얻어와 필드에 대입
